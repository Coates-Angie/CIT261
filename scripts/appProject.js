...
//Elf animation
elf.addEventListener("mouseover", function() {
    elf.style.animation = "elfGo 3s ease-in-out backwards";
});
...
xhr.onreadystatechange = function() {
    if (xhr.readyState == 4) {
        if (xhr.status == 200) {
            document.getElementById("note").textContent = xhr.responseText;
        }
...
xhr.open('get', 'funnyNote.txt', true);
xhr.send();